...
{
    public class InfusionRealtimeChatInitializer : DropCreateDatabaseIfModelChanges<InfusionRealtimeChatContext>
    {
        protected override void Seed(InfusionRealtimeChatContext context)
        {
            var users = new List<User>
                {
                    new User{UserId = 1, UserName = "ChadBroChill", Password = "123456", ConfirmPassword = "123456", RealName = "John", Email = "", About = "abc"},
                    new User{UserId = 2, UserName = "LiveLoveLaugh", Password = "123456", ConfirmPassword = "123456", RealName = "Jane", Email = "", About = "def"},
                    new User{UserId = 3, UserName = "MrsKanyeWest", Password = "123456", ConfirmPassword = "123456", RealName = "Mary", Email = "", About = "ghi"},
                    new User{UserId = 4, UserName = "BiebsFan111", Password = "123456", ConfirmPassword = "123456", RealName = "Bob", Email = "", About = "jkl"},
                    new User{UserId = 5, UserName = "Hacker1337", Password = "123456", ConfirmPassword = "123456", RealName = "Hacker", Email = "", About = "<script>alert('hacked!');</script>"}
                };
